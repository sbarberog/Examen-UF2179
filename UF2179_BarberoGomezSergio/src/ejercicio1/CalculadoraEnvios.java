...
public class CalculadoraEnvios extends JFrame {
	...
	protected void calculaPrecio() {
		...
		if(origen==null || origen.isBlank() || destino==null || destino.isBlank()) {
			JOptionPane.showMessageDialog(contentPane, "Debe introducir un origen y un destino", "Datos no válidos", JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		switch (tipoEnvio) {
		case 0: importe=importe+5; break;
		case 1: importe=importe+2; break;
		};
